...
import GestaoEstagiarios from '@/components/supervisor/gestaoEstagiarios';
import SupervisorDashboard from '@/components/supervisor/dashbord';
import Dashbord from '@/components/supervisor/dashbord';
import AdminDashbord from '@/components/admin/dashbord';
import ConfiguracoesSistema from '@/components/admin/configuracoes';
